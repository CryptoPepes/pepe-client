...
const PepeAuctionChartInner = (props) => {
    const {auction, auctionType, classes} = props;
...
PepeAuctionChartInner.propTypes = {
...
export default withStyles(styles)(PepeAuctionChartInner);
